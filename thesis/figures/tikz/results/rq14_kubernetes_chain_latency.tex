...
\coordinate (p1) at (1,0.651);
\coordinate (p2) at (3,1.885);
\coordinate (p3) at (5,3.424);
\coordinate (p4) at (7,5.540);
\coordinate (p5) at (9,5.681);
...
\node[pointlabel, above=0.18cm of p1] {81.447 ms};
\node[pointlabel, above left=0.05cm of p2] {84.189 ms};
\node[pointlabel, above left=0.05cm of p3] {87.608 ms};
\node[pointlabel, above=0.18cm of p4] {92.312 ms};
\node[pointlabel, above=0.18cm of p5] {92.624 ms};
...
\node[transferlabel] at (1,-0.95) {0 KiB};
...
\node[transferlabel, anchor=east] at (-0.25,-0.95) {cumulative\\transfer};
