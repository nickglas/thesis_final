...
% chain_2svc mean delta: 3.122 ms -> 1.717
% chain_2svc p95 delta:  3.531 ms -> 1.942
% chain_5svc mean delta: 9.008 ms -> 4.954
% chain_5svc p95 delta:  10.028 ms -> 5.515
...
\draw[meanbar] (1.15,0) rectangle (1.95,1.717);
\draw[tailbar] (2.10,0) rectangle (2.90,1.942);
\draw[meanbar] (5.55,0) rectangle (6.35,4.954);
\draw[tailbar] (6.50,0) rectangle (7.30,5.515);

\node[vallabel, text=blue!65!black, above] at (1.55,1.717) {3.122};
\node[vallabel, text=green!45!black, above] at (2.50,1.942) {3.531};
\node[vallabel, text=blue!65!black, above] at (5.95,4.954) {9.008};
\node[vallabel, text=green!45!black, above] at (6.90,5.515) {10.028};

\node[label] at (2.025,-0.45) {\texttt{chain\_2svc}\\1 protected boundary\\+4.5\% mean};
\node[label] at (6.425,-0.45) {\texttt{chain\_5svc}\\4 protected boundaries\\+11.7\% mean};
