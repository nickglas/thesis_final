...
$R^{2}\approx0.98$. The growth is therefore \emph{bounded and close to linear}
rather than super-linear, power-law, or exponential: the curve does not bend
upward as services are added. The departures from a perfectly constant per-hop
