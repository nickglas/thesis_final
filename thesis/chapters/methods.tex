...
defined in Chapter~\ref{chap:introduction}.
...
primary condition for interpretable systems performance results~\cite{Hoefler2015}.
...
relatable to prior split-computing and DNN-partitioning work~\cite{Kang2017,Stahl2021,Xu2023survey}.
...
meaningful boundaries rather than arbitrary layers~\cite{Kayal2024,Stahl2021,Xu2023survey}.
...
local-cluster noise~\cite{Hoefler2015}.
...
hardening layer, not as a complete inter-service secrecy mechanism~\cite{Poudel2025}.
