...
\begin{table}[htbp]
\centering
\caption{RQ1.1 summary of mean latency, dispersion, descriptive within-run per-iteration 95\% confidence interval on the mean, and overhead vs.\ monolithic. Source:
