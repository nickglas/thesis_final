...
The thesis-facing RQ1.1 benchmark used the frozen artifact
...
\begin{table}[htbp]
\centering
\caption{RQ1.1 summary of mean latency and overhead. Source:
\texttt{condition\_summaries.csv} in
\texttt{rq1\_1\_20260515\_111428}.}
\label{tab:rq11-results}
\begin{tabular}{lrrrr}
\toprule
\textbf{Condition} & \textbf{Mean (ms)} & \textbf{Median (ms)} & \textbf{Std. Dev. (ms)} & \textbf{Overhead vs. Monolithic} \\
\midrule
Monolithic & 77.24 & 75.29 & 3.59 & -- \\
Split after layer1 & 80.88 & 80.24 & 2.27 & 4.7\% \\
Split after layer2 & 80.12 & 79.60 & 2.40 & 3.7\% \\
Split after layer3 & 79.08 & 78.38 & 2.31 & 2.4\% \\
Split after layer4 & 79.58 & 78.85 & 2.43 & 3.0\% \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{RQ1.1 coarse split latency results under controlled local execution. \texttt{split\_after\_layer3} is the raw-fastest non-degenerate split; \texttt{split\_after\_layer4} is rejected by the compute-degeneracy rule despite its small intermediate activation. The carry-forward decision (see \texttt{carry\_forward.json} for \texttt{rq1\_1\_20260515\_111428}) selects \texttt{split\_after\_layer3} as the main candidate and \texttt{split\_after\_layer2} as the reference candidate.}
