...
The single-hop mTLS overhead scales monotonically with the size of the activation
crossing the protected hop. As the protected activation falls from 784~KiB
