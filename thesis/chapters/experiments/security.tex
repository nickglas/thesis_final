...
\begin{table}[ht]
\centering
\caption{Stage~H1 paired AKS security benchmark configuration. Sources: \texttt{merged/paired\_summary.md} in the two artifacts named below.}
...
\begin{table}[ht]
\centering
\caption{Stage~H1 latency results for plain and mTLS AKS chains. Sources: \texttt{merged/aggregated\_results.md} in \texttt{rq2\_1\_paired\_20260515\_160012} (\texttt{chain\_2svc}) and \texttt{rq2\_1\_paired\_20260517\_114303} (\texttt{chain\_5svc}).}
...
\begin{table}[ht]
\centering
\caption{Stage~H1 paired-pass latency deltas. Sources: \texttt{merged/aggregated\_results.md} (per-pass tables) in \texttt{rq2\_1\_paired\_20260515\_160012} and \texttt{rq2\_1\_paired\_20260517\_114303}. The pass-delta std is computed from the five per-pass deltas.}
...
\begin{table}[ht]
\centering
\caption{Stage~H1 \texttt{chain\_2svc} ablation of the communication-hardening bundle. Source: \texttt{merged/rq2\_1\_ablation\_summary.md} in \texttt{rq2\_1\_ablation\_20260516\_112348}. As documented in the evidence manifest, ablation deltas are internally comparable only and must not be spliced into the frozen two-condition paired result.}
...
\begin{table}[ht]
\centering
\caption{Stage~H1 resource and operational overheads. Sources: \texttt{merged/paired\_summary.md} in \texttt{rq2\_1\_paired\_20260515\_160012} (\texttt{chain\_2svc}) and \texttt{rq2\_1\_paired\_20260517\_114303} (\texttt{chain\_5svc}).}
...
\begin{table}[ht]
\centering
\caption{Stage~H2 benchmark configuration. Sources: \texttt{rq22\_rolling\_summary.json}, \texttt{rq22\_terraform.tfvars.json}, and \texttt{image\_reference.txt} in \texttt{rq2\_2\_confidential\_20260516\_135726}.}
...
\begin{table}[ht]
\centering
\caption{Stage~H2 service2-only confidential execution results. Source: per-pass \texttt{benchmark/raw\_iterations.csv} in \texttt{rq2\_2\_confidential\_20260516\_135726/conditions/}, aggregated across the five standard and five confidential passes (1,000 iterations per condition).}
