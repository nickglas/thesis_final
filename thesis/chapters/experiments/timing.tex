...
\begin{table}[t]
\centering
\caption{Stage~L3 supporting internal timing configuration. Source: \texttt{config.yaml} and \texttt{instrumentation\_overhead.json} in \texttt{internal\_timing\_resnet18\_20260515\_113614}.}
...
\begin{table}[t]
\centering
\caption{Stage~L3 heaviest internal compute units from the supporting timing analysis. Source: \texttt{summary.csv} in \texttt{internal\_timing\_resnet18\_20260515\_113614}, sorted by \texttt{mean\_ms} at level L3.}
