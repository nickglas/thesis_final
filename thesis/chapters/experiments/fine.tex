...
The thesis-facing RQ1.2 benchmark used the frozen artifact
\texttt{rq1\_2\_20260515\_112636} (source:
\texttt{results/frozen\_new/rq1\_2\_20260515\_112636/condition\_summaries.csv}).
...
of approximately 3.3\%, 3.6\%, and 3.6\%, respectively.

\begin{table}[t]
\centering
\caption{RQ1.2 summary of mean latency, overhead, and activation-transfer burden. Source: \texttt{condition\_summaries.csv} in \texttt{rq1\_2\_20260515\_112636}.}
...
(approximately 196~KB), the two conditions differ by approximately 7.8~ms in
...
Cross-round consistency was strong across all conditions, per
...
treated as representative of the run rather than as artefacts of a single
favourable round.
