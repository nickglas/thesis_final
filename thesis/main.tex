...
% TODO(author): replace with the final thesis title before submission.
...
% TODO(author): confirm host-organisation block. The template's fictional
% "Hilbert Institute for Space Research" has been removed. The remaining
% identifiers reflect the actual supervising parties (UvA Complex Cyber
% Infrastructure group and SIG); replace the logo path if a different image
...
% TODO(author): add real other committee members if any are required; the
% fictional template names have been removed. Leave the command commented out
% if no additional members participate.
% \othermembers{}
